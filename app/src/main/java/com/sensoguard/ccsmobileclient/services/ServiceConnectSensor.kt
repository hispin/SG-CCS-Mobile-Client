...
//
//        val tmpArr: Array<String> = alarmSensorId.split("-".toRegex()).dropLastWhile { it.isEmpty() }
//            .toTypedArray()
//        var zone = ""
...
//
//        val alarm =
//            Alarm(alarmSensorId, alarmSensorName, type, dateString, isArmed, tmp.timeInMillis,zone,false)
...
//        val dateString = dateFormat.format(tmp.time)
//
//        val tmpArr: Array<String> = currentSensorLocally.getId().split("-".toRegex()).dropLastWhile { it.isEmpty() }
//            .toTypedArray()
//        var zone = ""
//        if (tmpArr != null && tmpArr.size > 1) {
//            zone = tmpArr[1]
